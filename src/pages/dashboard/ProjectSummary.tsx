    ...
    <div className="col-span-1">
      <div className="card mb-6">
        <div className="px-6 py-5 flex justify-between items-center">
          <h4 className="header-title">Billing Summary</h4>
          <div>
            <PopoverLayout
              placement="left-start"
              togglerClass="text-gray-600 dark:text-gray-400"
              toggler={<i className="mgc_more_1_fill text-xl" />}
            >
              <div className="w-36 z-50 mt-2 transition-[margin,opacity] duration-300 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 rounded-lg p-2">
                ...
                <a
                  className="flex items-center gap-1.5 py-1.5 px-3.5 rounded text-sm transition-all duration-300 bg-transparent text-danger hover:bg-danger/5"
                  href=""
                >
        ...
        <div className="px-4 py-2 bg-warning/20 text-warning" role="alert">
          <i className="mgc_folder_star_line me-1 text-lg align-baseline"></i>{" "}
